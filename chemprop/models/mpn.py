...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, args: TrainArgs, atom_fdim: int, bond_fdim: int):
        ...
        print('Attention is ', self.attention)
        print('Attention path is ', args.viz_dir)
    ...
    def forward(self,
                ...
                viz_dir: str = None,
                fold_num: int = -1,
                model_idx: int = -1) -> torch.FloatTensor:
        """
        ...
        if self.use_input_features:
            ...
            # print('Feats ' ,torch.isnan(torch.sum(features_batch)))
        ...
        # print('F-atoms', torch.isnan(torch.sum(f_atoms)))
...
class MPN(nn.Module):
    ...
    def forward(self,
        ...
        # output = self.encoder.forward(batch, features_batch, viz_dir='./attention-32/')
    ...
    def viz_attention(self, batch: Union[List[str], BatchMolGraph],
        ...
        self.encoder.forward(batch, features_batch, viz_dir=self.viz_dir, fold_num=fold_num, model_idx=model_idx)
